...
if exist ..\client\static\StaticUpdateIds-w60-x86.txt del ..\client\static\StaticUpdateIds-w60-x86.txt
if exist ..\client\static\StaticUpdateIds-wupre-w60.txt del ..\client\static\StaticUpdateIds-wupre-w60.txt
if exist ..\exclude\ExcludeList-w60-x64.txt del ..\exclude\ExcludeList-w60-x64.txt
if exist ..\exclude\ExcludeList-w60-x86.txt del ..\exclude\ExcludeList-w60-x86.txt
if exist ..\exclude\ExcludeListISO-w60-x64.txt del ..\exclude\ExcludeListISO-w60-x64.txt
if exist ..\exclude\ExcludeListISO-w60-x86.txt del ..\exclude\ExcludeListISO-w60-x86.txt
if exist ..\exclude\ExcludeListUSB-w60-x64.txt del ..\exclude\ExcludeListUSB-w60-x64.txt
if exist ..\exclude\ExcludeListUSB-w60-x86.txt del ..\exclude\ExcludeListUSB-w60-x86.txt
for %%i in (enu fra esn jpn kor rus ptg ptb deu nld ita chs cht plk hun csy sve trk ell ara heb dan nor fin) do (
  if exist ..\static\StaticDownloadLinks-ie8-w60-x64-%%i.txt del ..\static\StaticDownloadLinks-ie8-w60-x64-%%i.txt
  if exist ..\static\StaticDownloadLinks-ie8-w60-x86-%%i.txt del ..\static\StaticDownloadLinks-ie8-w60-x86-%%i.txt
)
...
if exist ..\client\static\StaticUpdateIds-w61-seconly.txt del ..\client\static\StaticUpdateIds-w61-seconly.txt
if exist ..\client\static\StaticUpdateIds-w61-dotnet35.txt del ..\client\static\StaticUpdateIds-w61-dotnet35.txt
if exist ..\client\static\StaticUpdateIds-w61-dotnet35-seconly.txt del ..\client\static\StaticUpdateIds-w61-dotnet35-seconly.txt
for %%i in (379893 393297 394271 394806 460805 461310 461814 528049) do (
  if exist ..\client\static\StaticUpdateIds-w61-dotnet4-%%i.txt del ..\client\static\StaticUpdateIds-w61-dotnet4-%%i.txt
  if exist ..\client\static\StaticUpdateIds-w61-dotnet4-%%i-seconly.txt del ..\client\static\StaticUpdateIds-w61-dotnet4-%%i-seconly.txt
)
if exist ..\client\static\StaticUpdateIds-wupre-w61.txt del ..\client\static\StaticUpdateIds-wupre-w61.txt
if exist ..\exclude\ExcludeList-w61-x64.txt del ..\exclude\ExcludeList-w61-x64.txt
if exist ..\exclude\ExcludeList-w61-x86.txt del ..\exclude\ExcludeList-w61-x86.txt
if exist ..\exclude\ExcludeListISO-w61-x64.txt del ..\exclude\ExcludeListISO-w61-x64.txt
if exist ..\exclude\ExcludeListISO-w61-x86.txt del ..\exclude\ExcludeListISO-w61-x86.txt
if exist ..\exclude\ExcludeListUSB-w61-x64.txt del ..\exclude\ExcludeListUSB-w61-x64.txt
if exist ..\exclude\ExcludeListUSB-w61-x86.txt del ..\exclude\ExcludeListUSB-w61-x86.txt
for %%i in (enu fra esn jpn kor rus ptg ptb deu nld ita chs cht plk hun csy sve trk ell ara heb dan nor fin) do (
  if exist ..\static\StaticDownloadLinks-ie9-w61-x64-%%i.txt del ..\static\StaticDownloadLinks-ie9-w61-x64-%%i.txt
  if exist ..\static\StaticDownloadLinks-ie9-w61-x86-%%i.txt del ..\static\StaticDownloadLinks-ie9-w61-x86-%%i.txt
)
...
if exist ..\client\mssedefs\nul rd /S /Q ..\client\mssedefs
if exist ..\client\md\hashes-mssedefs.txt del ..\client\md\hashes-mssedefs.txt
if exist ..\exclude\ExcludeList-msse.txt del ..\exclude\ExcludeList-msse.txt
for %%i in (enu fra esn jpn kor rus ptg ptb deu nld ita chs cht plk hun csy sve trk ell dan nor fin glb) do (
  if exist ..\static\StaticDownloadLinks-msse-x64-%%i.txt del ..\static\StaticDownloadLinks-msse-x64-%%i.txt
  if exist ..\static\StaticDownloadLinks-msse-x86-%%i.txt del ..\static\StaticDownloadLinks-msse-x86-%%i.txt
)
if exist ..\client\msse\nul rd /S /Q ..\client\msse
if exist ..\client\md\hashes-msse.txt del ..\client\md\hashes-msse.txt

rem *** Old Windows Defender stuff ***
if exist ..\client\wddefs\x64-glb\mpas-fe.exe (
  del ..\client\wddefs\x64-glb\mpas-fe.exe
  if exist ..\client\md\hashes-wddefs.txt del ..\client\md\hashes-wddefs.txt
)
if exist ..\client\wddefs\x86-glb\mpas-fe.exe (
  del ..\client\wddefs\x86-glb\mpas-fe.exe
  if exist ..\client\md\hashes-wddefs.txt del ..\client\md\hashes-wddefs.txt
)

rem *** Silverlight stuff ***
if exist ..\client\win\glb\Silverlight.exe (
  del ..\client\win\glb\Silverlight.exe
  if exist ..\client\md\hashes-win-glb.txt del ..\client\md\hashes-win-glb.txt
)
if exist ..\client\win\glb\Silverlight_x64.exe (
  del ..\client\win\glb\Silverlight_x64.exe
  if exist ..\client\md\hashes-win-glb.txt del ..\client\md\hashes-win-glb.txt
)
...
%DLDR_PATH% %DLDR_COPT% %DLDR_NVOPT% %DLDR_POPT% ..\static %DLDR_LOPT% %DLDR_NCOPT% https://gitlab.com/wsusoffline/wsusoffline-sdd/-/raw/master/StaticDownloadFiles-modified.txt
%DLDR_PATH% %DLDR_COPT% %DLDR_IOPT% ..\static\StaticDownloadFiles-modified.txt %DLDR_POPT% ..\static
%DLDR_PATH% %DLDR_COPT% %DLDR_NVOPT% %DLDR_POPT% ..\exclude %DLDR_LOPT% %DLDR_NCOPT% https://gitlab.com/wsusoffline/wsusoffline-sdd/-/raw/master/ExcludeDownloadFiles-modified.txt
%DLDR_PATH% %DLDR_COPT% %DLDR_IOPT% ..\exclude\ExcludeDownloadFiles-modified.txt %DLDR_POPT% ..\exclude
%DLDR_PATH% %DLDR_COPT% %DLDR_NVOPT% %DLDR_POPT% ..\client\static %DLDR_LOPT% %DLDR_NCOPT% https://gitlab.com/wsusoffline/wsusoffline-sdd/-/raw/master/StaticUpdateFiles-modified.txt
...
%DLDR_PATH% %DLDR_COPT% %DLDR_NCOPT% %DLDR_IOPT% ..\static\StaticDownloadLink-mkisofs.txt %DLDR_POPT% ..\bin
if errorlevel 1 (
...
if exist ..\client\md\hashes-wddefs.txt (
  ...
  if exist ..\client\wddefs\%TARGET_ARCH%-glb\mpam*.exe (
    for %%i in (..\client\wddefs\%TARGET_ARCH%-glb\mpam*.exe) do echo _%%~ti | %SystemRoot%\System32\find.exe "_%DATE:~-10%" >nul 2>&1
    if not errorlevel 1 (
...
if "%SKIP_SDD%" NEQ "1" (
  ...
  %DLDR_PATH% %DLDR_COPT% %DLDR_NVOPT% %DLDR_POPT% ..\exclude %DLDR_LOPT% %DLDR_NCOPT% https://gitlab.com/wsusoffline/wsusoffline-sdd/-/raw/master/ExcludeList-superseded-exclude.txt
  ...
  %DLDR_PATH% %DLDR_COPT% %DLDR_NVOPT% %DLDR_POPT% ..\exclude %DLDR_LOPT% %DLDR_NCOPT% https://gitlab.com/wsusoffline/wsusoffline-sdd/-/raw/master/ExcludeList-superseded-exclude-seconly.txt
  ...
  %DLDR_PATH% %DLDR_COPT% %DLDR_NVOPT% %DLDR_POPT% ..\client\exclude %DLDR_LOPT% %DLDR_NCOPT% https://gitlab.com/wsusoffline/wsusoffline-sdd/-/raw/master/HideList-seconly.txt
...
if errorlevel 1 goto ExcludeForceAll
if not exist ..\Windows10Versions.ini goto ExcludeForceAll
...
rem
rem Some temporary files for the determination of superseded
rem updates and dynamic Office updates can be reused in the function
rem :DownloadCore. Therefore, the removal of these files is postponed
rem until the end of the script.
