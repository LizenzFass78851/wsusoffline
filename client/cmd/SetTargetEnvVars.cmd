...
if "%INSTALL_DOTNET4%"=="/instdotnet4" (
  if "%OS_VER_MAJOR%.%OS_VER_MINOR%.%OS_VER_BUILD_INTERNAL%"=="10.0.18362" (
    set DOTNET4_RELEASE_TARGET=528040
  ) else if "%OS_VER_MAJOR%.%OS_VER_MINOR%.%OS_VER_BUILD_INTERNAL%"=="10.0.19041" (
    set DOTNET4_RELEASE_TARGET=528372
  ) else if "%OS_VER_MAJOR%.%OS_VER_MINOR%.%OS_VER_BUILD_INTERNAL%"=="10.0.20438" (
    set DOTNET4_RELEASE_TARGET=528449
