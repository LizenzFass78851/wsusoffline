...
# Version: Linux download scripts, version 1.22-ESR
...
readonly script_version="1.22-ESR"
readonly release_date="2022-01-30"
...
then
    temp_dir="$(mktemp -d /tmp/update-generator.XXXXXX)"
else
...
function exit_handler ()
{
    ...
    then
        ...
        echo "Exiting update-generator.bash (normal exit)..."
    else
        # Keep temporary files for debugging
        printf '%s\n' "Keeping temporary files for debugging..."
        printf '%s\n' "Exiting update-generator.bash (error code ${result_code})..."
    fi
...
function update_generator ()
{
    ...
    run_tasks "update-generator-tasks"
    return 0
}
...
# TODO: Pass error codes from the download script
