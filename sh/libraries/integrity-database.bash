...
function create_integrity_database ()
{
    ...
    then
        ...
        log_message "${hashdeep_error_output}"
...
function verify_embedded_checksums ()
{
    ...
    do
        ...
        then
            ...
            # pushd/popd does not work anymore, because the message
            # functions will not find the log file, if the working
