...
# Extracted fields from sh/versions/installed-version.txt
sh_installed_version="not-available"
ignored_fields="not-available"

# Extracted fields from sh/versions/available-version.txt
...
sh_expanded_dirname="not-available"   # The name of the extracted
                                      # directory
...
function sh_self_update ()
{
    ...
    log_info_message "Copying new files to ${home_directory} ..."
    ...
    then
        ...
        do
            # All files and directories of the new version are copied to
            # the home directory of the scripts update-generator.bash
            # and download-updates.bash. The normalized, absolute
            # pathname of this directory is stored in the variable
            # ${home_directory}. It is usually the current working
            # directory when running the scripts.
            log_info_message "Copying ${current_item} ..."
            cp -a "${current_item}" "${home_directory}"
        done
    fi
